 ...
 * <p>
 * To use a GeofenceRemover, instantiate it, then call either RemoveGeofencesById() or RemoveGeofencesByIntent(). Everything else is done
 * automatically.
 * 
 */
public class GeofenceRemover implements ConnectionCallbacks, OnConnectionFailedListener, OnRemoveGeofencesResultListener {
	...
	/**
	 * Remove the geofences in a list of geofence IDs. To remove all current geofences associated with a request, you can also call
	...
	/**
	 * Remove the geofences associated with a PendIntent. The PendingIntent is the one used in the request to add the geofences; all geofences in that
	 * request are removed. To remove a subset of those geofences, call removeGeofencesById().
	 * 
	...
	/**
	 * Once the connection is available, send a request to remove the Geofences. The method signature used depends on which type of remove request was
	 * originally received.
	 */
	...
	public void onRemoveGeofencesByPendingIntentResult(int statusCode, PendingIntent requestIntent) {
		...
		if (statusCode == LocationStatusCodes.SUCCESS) {
			...
			Log.d(GeofenceUtils.APPTAG, mContext.getString(R.string.remove_geofences_intent_success));
	...
	public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) {
		...
		if (LocationStatusCodes.SUCCESS == statusCode) {
			 ...
			 */
			msg = mContext.getString(R.string.remove_geofences_id_failure, statusCode, Arrays.toString(geofenceRequestIds));
	...
	private void requestDisconnection() {
		...
		/*
		 * If the request was done by PendingIntent, cancel the Intent. This prevents problems if the client gets disconnected before the
		 * disconnection request finishes; the location updates will still be cancelled.
		 */
